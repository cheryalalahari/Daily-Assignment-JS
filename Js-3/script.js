...
function findmaxmin(arrayNum) {
  ...
  console.log(findmaxmin([7, 9, 20, 5, 4]));
...
const getDatemethods = (date) => {
 ...
 console.log(getDatemethods("2020-07-05"));
...
function FormatDateInLocales(date){
    ...
    console.log(FormatDateInLocales('2022-04-26'))
...
function addDaystoDate(date,Adddays){
    ...
    let result=addDaystoDate('2001-07-26',Adddays)
    console.log(result)
    ...
    let absoluteValue=Math.abs(-67)
    let flooredValue=Math.floor(45.89)
    let ceiledValue=Math.ceil(79.67)
    let loggedValue =Math.log(34.90)
    let exponentialValue=Math.exp(54.96)
